...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * ,---------------------------------------------------------------.
     * |Esc|  1|  2|  3|  4|  5|  6|  7|  8|  9|  0|  -|  =| Backsp|Hme|
     * |---------------------------------------------------------------|
     * | Tab |  Q|  W|  E|  R|  T|  Y|  U|  I|  O|  P|  [|  ]|  \  |End|
     * |---------------------------------------------------------------|
     * | CTRL |  A|  S|  D|  F|  G|  H|  J|  K|  L|  ;|  '| Enter  |PgU|
     * |---------------------------------------------------------------|
     * |Shift|FN(Z)|  X|  C|  V|  B|  N|  M|  ,| .|FN(/)| Shift |Up |PgD|
     * |---------------------------------------------------------------|
    ...
    [0] = LAYOUT( \
                 ...
                 KC_LSFT, KC_NUBS,LT(1, KC_Z),   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM,KC_DOT, LT(1, KC_SLSH),    KC_RSFT, KC_UP,  KC_PGDN,\
     ...
     */
    [1] = LAYOUT( \
        RESET, KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,  KC_F6,  KC_F7,  KC_F8,  KC_F9,  KC_F10, KC_F11, KC_F12, KC_TRNS,KC_INS,AG_NORM,\
        KC_TRNS,KC_TRNS,KC_TRNS,KC_UP  ,KC_TRNS,BL_TOGG,KC_TRNS,KC_TRNS,KC_UP  , KC_TRNS,KC_PSCR,KC_SLCK,KC_PAUS,KC_DEL,        AG_SWAP,\
        KC_TRNS,KC_TRNS,KC_LEFT,KC_DOWN,KC_RGHT,KC_TRNS,KC_TRNS,KC_LEFT,KC_DOWN,KC_RIGHT,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,        KC_VOLU,\
